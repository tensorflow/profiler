...
@NgModule({
  ...
  imports: [
    CommonModule, DiagnosticsViewModule, PerformanceSummaryModule,
    RecommendationResultViewModule, RunEnvironmentViewModule,
    StepTimeGraphModule, TopOpsTableModule,
    NormalizedAcceleratorPerformanceViewModule, InferenceLatencyChartModule
  ],
