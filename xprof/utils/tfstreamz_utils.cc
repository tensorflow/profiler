...
#include "xprof/protobuf/tfstreamz.pb.h"
...
tensorflow::profiler::tfstreamz::Percentiles ToProto(
    const monitoring::Percentiles& percentiles) {
  tensorflow::profiler::tfstreamz::Percentiles output;
  output.set_unit_of_measure(
      static_cast<tensorflow::profiler::tfstreamz::UnitOfMeasure>(
          percentiles.unit_of_measure));
