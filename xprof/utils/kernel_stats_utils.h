...
#ifndef XPROF_UTILS_KERNEL_STATS_UTILS_H_
...
#include "xprof/protobuf/kernel_stats.pb.h"

namespace tsl {
namespace profiler {

using ::tensorflow::profiler::KernelReport;
using ::tensorflow::profiler::KernelStatsDb;
...
#endif  // XPROF_UTILS_KERNEL_STATS_UTILS_H_
