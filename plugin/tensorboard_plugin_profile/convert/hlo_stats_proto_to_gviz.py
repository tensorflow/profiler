...
Usage:
    gviz_data_tables = generate_all_chart_tables(hlo_stats_db)
"""
...
def get_hlo_op_name_from_expression(hlo_op_expression):
...
def get_hlo_stats_table_args(hlo_stats_db):
...
def generate_hlo_stats_table(hlo_stats_db):
