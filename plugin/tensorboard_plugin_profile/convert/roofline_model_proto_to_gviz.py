...
def get_roofline_model_table_args(roofline_model_db):
  ...
  custom_properties = {
      ...
      "cmem_read_ridge_point": str(ridge_point(
          roofline_model_db.peak_flop_rate, roofline_model_db.peak_cmem_read_bw
      )),
      "cmem_write_ridge_point": str(ridge_point(
          roofline_model_db.peak_flop_rate, roofline_model_db.peak_cmem_write_bw
      )),
      "vmem_read_ridge_point": str(ridge_point(
          roofline_model_db.peak_flop_rate, roofline_model_db.peak_vmem_read_bw
      )),
      "vmem_write_ridge_point": str(ridge_point(
          roofline_model_db.peak_flop_rate, roofline_model_db.peak_vmem_write_bw
      )),
  }
...
def generate_roofline_model_table(roofline_model_db):
  ...
  if "GPU" not in device_type_str:
    (table_description, data, custom_properties) = (
        get_roofline_model_table_args(roofline_model_db)
    )
  else:
    (table_description, data, custom_properties) = (
