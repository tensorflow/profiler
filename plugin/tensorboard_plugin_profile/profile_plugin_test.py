...
class ProfilePluginTest(tf.test.TestCase):
  ...
  def testHosts(self):
    ...
    self.multiplexer.Reload()
    expected_hosts_foo = [
        {'hostname': 'host0', 'hasDeviceTrace': False},
        {'hostname': 'host1', 'hasDeviceTrace': False},
    ]
    expected_hosts_abc = [
        {'hostname': 'host1', 'hasDeviceTrace': False},
        {'hostname': 'host2', 'hasDeviceTrace': False},
    ]
    expected_all_hosts_only = [
        {'hostname': 'ALL_HOSTS', 'hasDeviceTrace': False},
    ]
